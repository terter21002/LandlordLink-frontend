    ...
    <>
      ...
      {!isLoggedIn && (
        <div className="container grid w-2/3 grid-cols-12 gap-4 bg-green tail-flex tail-w">
          <div className="col-span-8 tail-w pr-5">
            <img
            ...
            <div>
              ...
              <div className="grid grid-cols-12 gap-6 flex-wrap tail-flex">
              ...
              <div className="grid grid-cols-12 gap-4 flex-wrap tail-flex mt-4">
      ...
      {isLoggedIn && (
        <div className="container grid w-2/3 grid-cols-12 gap-4 bg-green tail-flex tail-w">
          <div className="col-span-2 tail-w"></div>
