          ...
          <div>
            ...
            <div className='grid grid-cols-12 gap-6 flex flex-wrap tail-flex'>
              <div className='col-span-6 text-center pb-40 border border-gray-200 tail-w'>
                    <span className='font-bold text-gray-500 text-2xl'>Purpose section</span>
              </div>
              <div className='col-span-6 pb-40 text-center border border-gray-200 tail-w'>
                   <span className='font-bold text-gray-500 text-2xl '>Features section</span>
              </div>
            </div>
            <div className='grid grid-cols-12 gap-4 flex flex-wrap tail-flex mt-4'>
              <div className='col-span-6 mt-2 grid grid-cols-12 gap-4 tail-w'>
                ...
                <div className='col-span-9'>
                  <h2 className='text-black-500 font-bold'>Title of the portal</h2>
                  <p>Creating safe AGI that benefits all of humanity. · Ask ChatGPT anything · Research · Research  </p>
                </div>
              </div>
              <div className='col-span-6 mt-2 grid grid-cols-12 gap-4 tail-w'>
                <div className='col-span-3 text-5xl text-blue-500'>
              ...
              </div><div className='col-span-6 mt-2 grid grid-cols-12 gap-4 tail-w'>
                <div className='col-span-3 text-5xl text-blue-500'>
                  <BsSpeedometer />
                </div>
                <div className='col-span-9'>
