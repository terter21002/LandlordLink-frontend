...
const ContactForm: React.FC = () => {
    ...
    return (
        <div>
            ...
            <div className='bg-blue-500 text-white border mx-auto max-w-7xl my-5 py-1 text-center border-gray grid grid-cols-12 gap-4 tail-flex'>
                <button className='hover:mouse-cursor text-2xl font-bold hover:text-orange-400 ml-2 col-span-11 tail-w'>Upload Tenant from Lease Agreement</button>
